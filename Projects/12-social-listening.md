...
- **Not to be confused with** [15-listening-console](./15-listening-console.md) — the internal build
  at `Downloads/Social Media Listening Tools` on Laravel 12. Same idea, **separate codebase**.
