...
- [SociaPulse](./Projects/16-sociapulse.md) - Unified social media management SaaS across Facebook Pages/Instagram/Threads/YouTube/X, publish-first (Laravel 12 + PHP 8.4 + Inertia + Vue 3 + TS + Bootstrap/AdminLTE + PostgreSQL + Redis + Horizon) - `Desktop/Codex Lure/project/SociaPulse` - **own SaaS** - **[LEARN]** (PostgreSQL) - **MVP BUILT 2026-09-12** - all 7 phases verified, 224 tests / 771 assertions, CS verify 100/100, security review clean - repo `github.com/wafazz/SociaPulse` (private) - blocked only on §37 external prerequisites (Meta/Google verification, object storage, OQ-08 YouTube retention) - separate product from [12-social-listening](./Projects/12-social-listening.md) and [15-listening-console](./Projects/15-listening-console.md)
