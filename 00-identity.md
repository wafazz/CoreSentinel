...
- [larisHQ](./Projects/08-larishq.md) - Agent/Stockist + Marketer/Sales Team management & ordering SaaS, dynamic 1-8 level network hierarchy (Laravel 12 + Inertia 3 + Vue 3.5 + AdminLTE 4 + MariaDB) - `Desktop/Codex Lure/project/SaaS - New Version AMS` - **own SaaS** - PH01–PH13 verified 2026-09-02, 13/18 phases; 331 tests; zero open questions; next PH14 Reports
